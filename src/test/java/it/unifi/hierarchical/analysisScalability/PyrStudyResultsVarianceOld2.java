...
public class PyrStudyResultsVarianceOld2 {

	public PyrStudyResultsVarianceOld2() {
	...
	public static void main(String[] args){
		...
		for(String pathnameS: pathnamesSample) {
			...
			File file = new File("src//main//resources//pyramisRes//prb_"+pathnames[0].substring(0,3));
