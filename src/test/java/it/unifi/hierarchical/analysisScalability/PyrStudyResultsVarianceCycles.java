...
public class PyrStudyResultsVarianceCycles {
	...
	public static void main(String[] args){
		...
		if(pathnamesSample==null) {
			System.out.println("No such directory : I was expecting src//main//resources//pyramisSimulationCycles refer to Readme.md on which steps are needed to reach here");
			return;
		}
