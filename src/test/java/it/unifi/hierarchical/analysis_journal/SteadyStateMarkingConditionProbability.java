 ...
 */
public final class SteadyStateMarkingConditionProbability extends BasicReward {
	 ...
	 */
	public SteadyStateMarkingConditionProbability(Sequencer sequencer, RewardTime rewardTime, int samples,
	...
	public void update(SequencerEvent event) {
		...
		case FIRING_EXECUTED:
			...
			if (markingCondition.evaluate(this.getSequencer().getLastSuccession().getParent()
