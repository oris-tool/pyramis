 ...
 *  
 */
// for changed_from(24) / 168 second 
public class PyramisSampler2 {

	public static void main(String[] args){
		int[] i96b = new int[] {78,84,90};
...
//			}
	...
	private static void initialize(int VMMTIME,Map<String,Double> probs, Map<String,Sampler> samplers) {
		...
		samplers.put("VmFD", new UniformSampler(new BigDecimal("0.0"), new BigDecimal("0.2")));
		samplers.put("VmRej", new UniformSampler(new BigDecimal("0.1"), new BigDecimal("0.2")));
		...
		samplers.put("VmmRejW", new DetSampler(168));
		samplers.put("VmmFD", new UniformSampler(new BigDecimal("0.0"), new BigDecimal("0.2")));
		...
		samplers.put("VmmRej", new UniformSampler(new BigDecimal("0.1"), new BigDecimal("0.3")));
