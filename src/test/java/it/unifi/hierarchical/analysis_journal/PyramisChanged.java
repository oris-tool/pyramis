...
import it.unifi.hierarchical.model.example.hsmp_journal.HSMP_JournalChanged;
...
public class PyramisChanged {
	...
	public static void test1() {    
		double[] tics= new double[]{0.005, 0.005,0.005,0.005}; //0.02,0.01,0.005,0.0025
...
//				"8_cycles_vmmRejExpol_"+TIME_STEP+".txt";
				...
				//HSMP
				//Build the model
				HierarchicalSMP model = HSMP_JournalChanged.build();
