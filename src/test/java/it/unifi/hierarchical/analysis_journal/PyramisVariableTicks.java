...
import it.unifi.hierarchical.model.example.hsmp_journal.HSMP_JournalVariableTicks;
...
public class PyramisVariableTicks {
	...
	//	0.0005,  0.001,  0.00025 
	//	
	//0.0025,  0.0025,  0.0025,0.005,0.005,   0.005,  0.005  
    //0.0025,  0.0025,  0.0025,0.005,0.005,   0.005,  0.005  
	//0.0025,  0.00025, 0.0005,0.005,0.0005,  0.001,  0.00025//	{0.0025,  0.0025 };  
	//0.0025,  0.00025, 0.0005,0.005,0.0005,  0.001,  0.00025//	{0.0025,  0.0025 };  
	//	{0.00025, 0.0005}; 
	//	{0.00025, 0.0005}; 
	...
	public static void test1() {    
		...
		double TIME_STEP= -1;
		double[] timeVMA=    new double[]{0.0025 ,0.0025 ,0.0025 ,0.0025 ,0.0025 ,0.0025 ,0.0025 	};	// stato Vm (attenzione!! NON supportato al momento!!) lasciare uguale a regione Never
		double[] timeR1= 	 new double[]{0.0025 ,0.0025 ,0.0025 ,0.0025 ,0.0025 ,0.0025 ,0.0025 	};	// regione Never
		double[] timeVMMA=	 new double[]{0.00125,0.00125,0.00125,0.00125,0.00125,0.00125,0.00125}; //S0 e regioni parallele
		double[] timeEX= 	 new double[]{0.00125,0.00125,0.00125,0.00125,0.00125,0.00125,0.00125}; //esterni
