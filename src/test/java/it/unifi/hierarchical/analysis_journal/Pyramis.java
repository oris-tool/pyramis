...
public class Pyramis {
	...
	public static void test1() {    
		double[] tics= new double[]{0.02,0.01,0.005,0.0025}; //0.02,0.01,0.005,0.0025
...
//				"8_cycles_vmmRejExpol_"+TIME_STEP+".txt";
				...
				String print= "8_cycles_AllExpol_"+TIME_STEP+".txt";
				
	
				//HSMP
				//Build the model
				HierarchicalSMP model = HSMP_Journal.build();
