...
import it.unifi.hierarchical.model.example.hsmp_journal.HSMP_TestDepth;
...
public class TestDepth {
    ...
    public void test1() {     
        //HSMP
        //Build the model
        HierarchicalSMP model = HSMP_TestDepth.build();
		...
		File file = new File("DEPTH"+TIME_STEP+".txt");
