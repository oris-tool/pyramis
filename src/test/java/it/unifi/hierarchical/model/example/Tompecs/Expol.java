...
public class Expol {
  public static void build(PetriNet net, Marking marking) {
    ...
    t12.addFeature(new PostUpdater("p6=0,p7=0,p8=0,p9=0,p10=0,p11=0", net));
    ...
    t19.addFeature(new PostUpdater("p0=0,p1=0,p2=0,p3=0,p4=0,p5=0", net));
